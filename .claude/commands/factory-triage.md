---
description: factory triage stage dispatcher
allowed-tools: Workflow(factory-triage), Read(.factory/out/loaded.json)
---
...
2. Call the Workflow tool with name `factory-triage` and args
