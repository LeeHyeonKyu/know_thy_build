...
prot='(\.factory/|\.claude/|\.github/|docs/factory/CHARTER\.md|CLAUDE\.md|AGENTS[a-zA-Z0-9._-]*\.md|\.mcp[a-zA-Z0-9._-]*\.json|package\.json|package-lock\.json|vitest\.config\.|playwright\.config\.|tsconfig[a-zA-Z0-9._-]*\.json|\.eslintrc|eslint\.config\.)'
if [ "${FACTORY_HARNESS_ISSUE:-}" = "1" ]; then
  prot='(\.factory/bin/|\.factory/lib/|\.factory/actions/|\.factory/lessons/|\.factory/scenarios/|\.factory/node_modules/|\.factory/out/|\.factory/out/coverage/|\.factory/out/prove-wt/|\.factory/out/classify-wt/|\.factory/ci-settings[a-zA-Z0-9._-]*\.json|\.factory/roles\.toml|\.factory/quarantine\.toml|\.factory/package\.json|\.factory/package-lock\.json|\.claude/|\.github/|docs/factory/CHARTER\.md|CLAUDE\.md|AGENTS[a-zA-Z0-9._-]*\.md|\.mcp[a-zA-Z0-9._-]*\.json|tsconfig[a-zA-Z0-9._-]*\.json|\.eslintrc|eslint\.config\.)'
fi
# <<< factory:protected
